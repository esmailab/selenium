...
public class BearingPointTest extends TestbaseBP{
	...
	public void pearingpointTest() throws InterruptedException {
		...
		//element.click();
		driver.get("https://www.bearingpoint.com/de-de/unser-team/karriere/");
		ScreenShotMethode.captureScreenShot(driver);
		driver.get("https://www.bearingpoint.com/de-de/unser-team/karriere/karrierebeibearingpoint/");
		ScreenShotMethode.captureScreenShot(driver);
			}
